...
<section class="container bg-circulos">
    <div class="grid-container">
        <!-- <h1>Biblioteca</h1> -->
        <h2>¿Dudas sobre la vacunación?</h2>
        <h3>Prefuntas más frecuentes:</h3>
        <ul class="collapsible">
            ...
            <li>
                ...
                <div class="collapsible-body">
                    <p>
                        <ul class="ul">
                            <li>Tuberculosis (formas graves: miliar y meníngea)</li>
                            <li>Hepatitis B</li>
                            <li>Difteria</li>
                            <li>Tos ferina</li>
                            <li>Tétanos</li>
                            <li>Haemophilus Influenza tipo B</li>
                            <li>Poliomielitis</li>
                            <li>Diarreas por rotavirus</li>
                            <li>Neumonías ocasionadas por neumococo</li>
                            <li>Sarampión</li>
                            <li>Rubéola</li>
                            <li>Parotiditis o paperas</li>
                            <li>Infección por virus del papiloma humano e influenza</li>
                        </ul>
                    </p>
                </div>
            </li>
    ...
    <div class="grid-container">
        ...
        <div class="box-container equipo">
            ...
            <p>
                ...
                aperiam aliquam corporis. Nesciunt ad animi ducimus possimus 
